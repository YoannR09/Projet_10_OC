...
<div id="page">
    ...
    <div id="barreDeRecherche" class="bg-light">
        <s:form id="formulaire" action="rechercheAbonneResaForm" >
            ...
            <table class="table" id="tableau">
                ...
                <s:iterator value="abonneList">
                    <tr>
                        ...
                        <td id="tdBtnSelectionner"><s:a action="listResa" class="btn btn-info" style="font-size:0.6em;"><i class="fas fa-arrow-alt-circle-right"></i><s:param name="abonneId" value="id"/></s:a></td>
                    </tr>
                </s:iterator>
                </tbody>
            </table>
